...
//                    if let imageString = userProfile.profileImage {
...
//        tableView.backgroundColor = .systemBackground//UIColor(rgb: 0xCDCCCC, alpha: 1)//.systemBackground
...
//        let isTrue = (userProfile.userId != nil) && (userProfile.languageNames?.count ?? 0 > 0) && (userProfile.languageLevels?.count ?? 0 > 0) && (userProfile.userName?.count ?? 0 >= 2) && (userProfile.userAge != nil) && (userProfile.gender != nil) && (userProfile.nationality != nil) && (userProfile.profileImage != nil)
//        return isTrue
//    }
//    
//    // viewload 시 get 요청
...
//        }
//        
////        let urlConvertible = UpdateProfileRouter.uploadEssentialProfile(parameters: userProfile)
...
////                    }
////                }
////            }, to: urlConvertible, method: urlConvertible.method)
...
//}
//
//extension EditProfileViewController: ImagesProtocol {
...
//
//
//extension EditProfileViewController: LanguageProtocol {
...
//}
//
//extension EditProfileViewController: NationalityProtocol {
