...
//        request.autoContentAccessingProxy = mapView.region
        
//        searchVC.searchBar.backgroundColo r = .systemBackground

//        navigationBarAppearace.tintColor = UIColor.blue
//        navigationBarAppearace.barTintColor = .blue
//        navigationController?.navigationBar.isHidden = true
//        navigationController?.navigationBar.barTintColor = UIColor.green
//        self.navigationItem.titleView?.backgroundColor = .systemBackground
